...
//        fuel2 = Fuel.builder().name("LPG").build();
//        garage = Garage.builder().id(1L).capacity(3).isLpgAllowed(false).placeWidth(2.5).build();
//        garage2 = Garage.builder().id(2L).capacity(2).isLpgAllowed(true).placeWidth(3.5).build();
//        car = Car.builder().brand("BMW").width(2.3).price(BigDecimal.valueOf(299000.4)).fuel(fuel).garage(garage)
//                .build();
//        car2 = Car.builder().brand("LAMBORGHINI").width(2.9).price(BigDecimal.valueOf(4324212.4)).fuel(fuel2).garage(garage2)
//                .build();
//        carDto = CarDto.builder().brand("BMW").width(2.3).price(BigDecimal.valueOf(299000.4)).fuelName("Petrol")
//                .build();
//        car2Dto = CarDto.builder().brand("LAMBORGHINI").width(2.9).price(BigDecimal.valueOf(4324212.4)).fuelName("LPG")
//                .build();
//        garageId = 1L;
//        fuelId = 1L;
//    }
